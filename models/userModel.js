...
// userSchema.virtual('bookings').get(async function () {
//   let mybookings = ['hello'];
//   return {
//     hello: 'hello',
//   };
// });
...
userSchema.post('save', function (next) {
  if (this.photo != 'default.jpg') {
    this.photo = this.photo.replace('#####', this.id);
  }
});

userSchema.methods.verifyPassword = async (givenPassword, databasePassword) => {
